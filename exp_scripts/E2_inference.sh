...
do
    ...
    LOAD_DIR=$NAME
    RELOAD_MODEL="/home/ckruse/PythonProjects/Causality-Medical-Image-Domain-Generalization/checkpoints/CAUSALDG_E2_sourceMR_efficient_b2_unet/1/snapshots/latest_net_Seg.pth"
