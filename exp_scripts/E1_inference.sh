...
DATASET='ABDOMINAL'
BASEDIR='/home/ckruse/PythonProjects/Causality-Medical-Image-Domain-Generalization/data/E1/'
...
do
    ...
    LOAD_DIR=$NAME
    RELOAD_MODEL="/home/ckruse/PythonProjects/Causality-Medical-Image-Domain-Generalization/checkpoints/CAUSALDG_E1_sourceMR_efficient_b2_unet/5/snapshots/latest_net_Seg.pth"
