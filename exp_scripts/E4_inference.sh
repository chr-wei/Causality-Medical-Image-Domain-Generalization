...
DATASET='ABDOMINAL'
BASEDIR='/home/ckruse/PythonProjects/Causality-Medical-Image-Domain-Generalization/data/E4/'
...
do
    ...
    LOAD_DIR=$NAME
    RELOAD_MODEL="/home/ckruse/PythonProjects/Causality-Medical-Image-Domain-Generalization/checkpoints/CAUSALDG_E4_sourceCT_efficient_b2_unet/1/snapshots/latest_net_Seg.pth"
