...
SAVE_EPOCH=1000
SAVE_PRED=True # save prediction results or not

DATASET='ABDOMINAL'
BASEDIR='/home/ckruse/PythonProjects/Causality-Medical-Image-Domain-Generalization/data/E3/'
...
do
    ...
    LOAD_DIR=$NAME
    RELOAD_MODEL="/home/ckruse/PythonProjects/Causality-Medical-Image-Domain-Generalization/checkpoints/CAUSALDG_E3_sourceMR_efficient_b2_unet/3/snapshots/latest_net_Seg.pth"
