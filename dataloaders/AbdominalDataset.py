    ...
    def __search_samples(self, scan_ids):
        ...
        for _domain, id_list in scan_ids.items():
            ...
            for curr_id in id_list:
                ...
                _img_fid = os.path.join(self._base_dir, _domain , 'processed_large'  ,f'image_{curr_id}.nii.gz')
                _lb_fid  = os.path.join(self._base_dir, _domain , 'processed_large', f'label_{curr_id}.nii.gz')
